import {color2Hex, extend, mobileCheck, q} from './helpers.js'
...
VANTA.VantaBase = class VantaBase {
    constructor(userOptions = {}) {
        ...
        if (this.el == null) {
            ...
            this.el = q(selector, this.options.contextWindow);
            if (!this.el) {
        ...
        // Add event listeners windowContexton window, because this element may be below other elements, which would block the element's own mousemove event
